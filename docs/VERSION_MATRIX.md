...
| `V01.00.000-beta-01` | version single-sourcing + gate; `check --json` v0; coherent CLI (help/exit codes); SSE2 float arithmetic; fold-corruption + pinned-register fixes | unchanged | **internal allocator funnel**, poison-on-free debug | toml corrected | unchanged | unchanged | — | unchanged | — | — | CI secret-scan preflight | unchanged | **current tag** |
